...
abstract: |
  ...
  more in desirable qualitative parenting. When mothers were disproportionally
...
\vspace{\baselineskip}
Emotional adjustment is defined as the absence of internalizing symptoms and emotional dysregulation [@goodmanPsychometricPropertiesStrengths2001]. It is integral to social competence, academic achievement, and mental health [@grossHandbookEmotionRegulation2013]. Emotional adjustment development is a domain in which fathers might play a unique role, because fathers encourage children to challenge themselves, in play and in life [@flouriFathersBehaviorsChildren2010; @bogelsDoesFatherKnow2011; @parkeFatherInvolvement2000]. The attachment relationships between children and parents are grounded in a balance between security and exploration [@grossmannDeveloppementAttachementAdaptation1998]. Fatherhood researchers have posited that warmth and security are more central to mother-child attachment relationships, whereas father-child relationships have been construed as "activation relationships", with greater emphasis on exploration [@paquetteFatherChildActivationRelationship2013]. By encouraging children to venture outside their comfort zone, fathers stimulate a broad spectrum of emotions, thereby expanding children's emotional repertoire, and engaging their developing regulatory abilities.

## Fatherhood theory

The past decades have seen major strides in the consolidation of theories to guide fatherhood research. Inspired by increasing divorce rates and maternal employment, early fatherhood research primarily operationalized involvement in *quantitative* terms: Presence versus absence in divorced families, and the sharing of childcare duties in dual-earner families [@lambBiosocialPerspectivePaternal1987]. Over time, the notion of the father as a coparent gained ground [@pleckFatherhoodIdealsUnited1997], according to which fathers should share childrearing responsibilities with mothers, adopting roles historically fulfilled by mothers. To keep pace with changing fatherhood norms, definitions of father involvement evolved to incorporate *qualitative* dimensions, such as warmth and control [@maccobySocializationContextFamily1983; @pleckPaternalInvolvementRevised2004]. 

Although it is now widely acknowledged that involvement quality and quantity are both relevant to child development [@faganShouldResearchersConceptualize2014; @pleckPaternalInvolvementRevised2004], these dimensions are rarely investigated together. Historically, developmental psychology has emphasized how qualitative parenting behaviors shape child development, whereas sociology and gender studies have focused on involvement quantity and its implications for maternal well-being and gender equality [@craigDoesFatherCare2006; @faganShouldResearchersConceptualize2014]. The present study attempts to bridge these approaches by investigating both qualitative and quantitative involvement, and the interplay between them, in relation to children's emotional adjustment.
...
Interactions between involvement quality and quantity have largely been overlooked in theoretical models of father involvement; perhaps in part because these two dimensions have rarely been jointly investigated [@jaffeeLifeFatherBenefits2003]. In this respect, theories of father involvement can be complemented by Feinberg's coparenting model [@feinbergInternalStructureEcological2003]. Coparenting refers to the ways parents relate to each other in the role of parent. Although the coparenting literature is typically invoked to describe childrearing in divorced families, it also holds insights for intact families. According to Feinberg, the "division of labor" in childcare, analogous to our operationalization of differential involvement, affects qualitative childrearing behaviors and children's adjustment directly, and moderates the link between these two constructs. 
...
reg_table(rbind(tabinv, tabinvmod), caption = "Effects of quantitative involvement", note = "Emo.: Emotional adjustment. *: <5% of posterior has opposite sign from estimate.")
```

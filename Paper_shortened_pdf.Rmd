...
Sex differences are a relevant factor in the interplay between parenting and emotional adjustment. Parents tend to raise boys and girls differently; expressing more control with girls [@pomerantzRoleMaternalControl1998; @vanlissaRoleFathersMothers2018a], and more negative parenting with boys [@strausCorporalPunishmentAmerican1999]. Furthermore, social learning theory posits that the same-sex parent plays a stronger role in socialization; particularly for sex-typed behavior, such as emotion display rules [@busseySocialCognitiveTheory1999]. Finally, mounting evidence suggests that parental sensitivity is greatest in mother-daughter relationships, and lowest in father-son relationships [see @vanlissaRoleFathersMothers2018a]. We therefore hypothesize that parents will display more responsiveness, structure, and inductive reasoning towards girls, and more negative parenting towards boys. Furthermore, we predict stronger associations between qualitative parenting and emotional adjustment between children and the same-sex parent. 
...
#tab[is.na(tab)] <- ""
rownames(tab) <- NULL
reg_table(tab, caption = "Between-family level intercepts and variances of within-family predictive effects", note = "Est.: Estimate. HDPI: Highest posterior density interval. Emo.: Emotional adjustment. *: <5% of posterior has opposite sign from estimate.")
```

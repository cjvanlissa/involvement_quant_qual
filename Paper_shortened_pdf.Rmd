...
In line with prior research, we found that both parents displayed more anger and inductive reasoning, and less warmth, towards sons than towards daughters. These findings suggest that parents are stricter with sons. Sex did not moderate parenting effects, which suggests that boys and girls are similarly affected by qualitative parenting behaviors. Sex did moderate child effects, however: Emotional adjustment predicted both parents' inductive reasoning more negatively when children were male. This finding suggests that some of parents' greater strictness toward boys is alleviated when boys are well-adjusted.

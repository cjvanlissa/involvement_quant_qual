...
## Predictive effects between within-family changes in parenting and emotional adjustment
...
## Differences between mothers and fathers
<!-- All within-family predictive effects varied significantly across families, however, which highlights the importance of capturing and explaining these differences. This variability was notably greater for fathers than mothers, which suggests that fathers' influence is more context-dependent. -->

Overall, we found somewhat more evidence for associations of emotional adjustment with mothers' qualitative parenting, than with fathers' parenting, and we found some evidence for differences between mothers' and fathers' roles in emotional adjustment development at the within-family level. These findings are in line with existing theory [@faganShouldResearchersConceptualize2014; @paquetteTheorizingFatherchildRelationship2004]. Stable between-family differences in mothers' and fathers' parenting behaviors were all similarly associated with children's adjustment, however.

Within-family associations of emotional adjustment with consistency were stronger for mothers, and associations with warmth and reasoning were stronger for fathers. As mentioned before, mothers tend to spend more time with their children than fathers; also in our sample. This might explain why associations for maternal consistency were stronger: Spending more time with the child provides greater opportunity for consistent behavior. For fathers, associations were stronger for inductive reasoning and warmth - behaviors which can also be expressed in one-off interactions, such as when  disciplining a child (inductive reasoning), or during play time (warmth). The stronger association with inductive reasoning for fathers is in line with the classic view of the father as disciplinarian [@flouriFathersBehaviorsChildren2010].

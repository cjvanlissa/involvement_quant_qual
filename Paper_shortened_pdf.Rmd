...
Parental anger expressions negatively impact children's emotional adjustment [@scaramellaParentingChildrenDistress2008], because parental anger is upsetting, and because anger reflects poor parental emotion regulation, which serves as a model for children [@changHarshParentingRelation2003]. We thus hypothesized that it would be negatively related to emotional adjustment, $H_{1d}$.

### Parent or child effects?
<!-- Hier iets doen 
Was wel echt meer control, maar rigid control oid?-->
...
We are, however, a bit cautious about formulating more focused hypotheses about within- versus between-family effects than the one formulated above. Because there is no precedent for using the random-intercept cross-lagged panel model or its multilevel DSEM extension in the literature on parental involvement and emotional adjustment, there is no literature upon which to base such hypotheses. Our examination of between and within-family effects will therefore mainly be exploratory. 
-->

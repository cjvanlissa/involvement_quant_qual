...
#tab[is.na(tab)] <- ""
rownames(tab) <- NULL
cat(as.character(reg_table(tab, caption = "Effects of quantitative involvement", note = "Emo.: Emotional adjustment. *: <5% of posterior has opposite sign from estimate.")))
```

...
DEV-2019-2824
Quantitative involvement moderates longitudinal associations between mothers’ and fathers’ qualitative parenting and children’s emotional adjustment
...
1. The opening paragraph does not convince me that fathers may uniquely contribute to children's emotional adjustment. I can see the argument that fathers may stimulate emotion by encouraging children outside of their comfort zones, but warmth and security (what the authors argue mothers do more of) should also make emotion safe and commonplace.
2. I don't think "incursions" is the right word (line 65).
3. Please do not capitalize the word after a colon within a sentence. In general there are some grammatical problems throughout that should be addressed before publication. There are also some typos (e.g., line 236 "agerage instead of average").
4. Can you say more about why parental anger is thought to undermine emotion regulation?
...
7. If you have income from ~1700 dads, why are you only reporting it for ~700?
8. I understand the need to maintain a blind document, but with so much information about the sample removed it is very hard to interpret the results. I did not realize the sample spanned two continents/cultures until the discussion - there is no mention of potential site differences before that point, or a discussion of how parenting is the same or different in different cultures.
9. Please provide examples of the structure and negative parenting items used.
10. Please define measurement invariance (parentheses is fine - e.g., measurement equivalence) for the less statistically trained reader.
...
338 the next year.
13. Line 383 you use "discipline" for the first time. Do you mean demandingness?
